    ...
    <div className="content-width-limit">
      ...
      {selectedId !== null && (
        <nav className="bottom-nav">
          ...
          >
            <div
              style={{ width: '50px', height: '50px', borderRadius: '50%', background: '#FFFFFF', border: '2px solid #10B981', boxShadow: '0 4px 12px rgba(16, 185, 129, 0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#059669', fontSize: '28px', fontWeight: 500, zIndex: 1600, transform: 'translateY(-18px)', transition: 'all 0.15s ease-in-out', lineHeight: 1 }}
              className="hover-up"
            >
              +
            </div>
